...
var select = function select(elem) {
  return document.querySelector(elem);
};
var selectAll = function selectAll(elem) {
  return document.querySelectorAll(elem);
};
var text = selectAll('.preview__title');
var main = select('main');
var petItems = selectAll('.projects__pet-link');
var toggleMenu = select('.header-page__toggle');
var breakpoint = window.matchMedia('(min-width:1200px)');
var breakpointModal = window.matchMedia('(min-width:320px)');
var breakpointTablet = window.matchMedia('(min-width:320px)');
var mainLink = document.querySelector('.main-link');
var aboutUs = document.querySelector('.about-us-link');
var skills = document.querySelector('.skills-link');
var projects = document.querySelector('.projects-link');
var contacts = document.querySelector('.contacts-link');
var links = selectAll('.header-page__link');
var splitTextMy = function splitTextMy(el) {
...
Array.from(document.querySelectorAll('.letter')).forEach(function (el, idx) {
...
gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.from('.preview__list', {
  opacity: 0,
  duration: 5,
  stagger: 0.6,
  delay: 1
...
var breakpointChecker = function breakpointChecker() {
  if (breakpoint.matches) {
    ...
    tl.fromTo('.projects__list-site', {
      x: 0
    }, {
      x: '-180%',
      duration: 400
    });
    tl.fromTo('.projects__pet', {
      x: '0',
      y: '0'
    }, {
      x: '0',
    ...
    tl.fromTo('.contacts', {
      ...
      y: 0,
      onUpdate: animationContactTitle
    });
    tl.to('.contacts-link', {
      color: '#163631',
      fontSize: '28px',
...
function animationContactTitle() {
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.fromTo('.contacts__title', {
    x: 0,
    opacity: 0
  }, {
    x: '10px',
  ...
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.fromTo('.contacts__link-container', {
    x: '-100%',
    color: '#fff'
  }, {
    x: '10px',
  ...
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.fromTo('.contacts__form', {
    opacity: 0
  }, {
    opacity: 1,
    delay: 2,
...
function defaultOpacity() {
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to('.contacts__title', {
    opacity: 0
  });
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to('.contacts__form', {
    opacity: 0
  });
}
petItems.forEach(function (item) {
  item.addEventListener('mouseover', function () {
    ...
    var imgesPet = document.querySelectorAll('.img-select');
    imgesPet.forEach(function (img) {
      var imgId = img.getAttribute('data-id');
      if (Number(imgId) === Number(idItem)) {
        // eslint-disable-next-line max-nested-callbacks
        imgesPet.forEach(function (itemImg) {
...
function getDefaultValues(elem) {
  var items = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : links;
...
mainLink.addEventListener('click', function () {
  ...
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to('.preview', {
    opacity: 1
  });
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to('.about-us', {
    x: '-100%',
    y: '-100%',
    opacity: 1
  });
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to('.presentation', {
    display: 'block'
  });
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to('.skills', {
    opacity: 0
  }, {
    opacity: 1
  });
  ...
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to('.projects', {
    x: '0%'
  });
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to('.projects__list-site', {
    x: 0
  });
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to('.projects__pet', {
    x: '0',
    y: '0'
  });
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(petItems, {
    x: '-500%'
  });
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to('.contacts', {
    x: '-300%',
    y: '-300%',
    duration: 2
  });
...
aboutUs.addEventListener('click', function () {
  ...
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.fromTo('.preview', {
    opacity: 1
  }, {
    opacity: 0
  });
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.fromTo('.about-us', {
    x: '-100%',
    y: '-100%',
    opacity: 0
  }, {
...
skills.addEventListener('click', function () {
  ...
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.fromTo('.skills', {
    opacity: 0
  }, {
    opacity: 1
  });
...
projects.addEventListener('click', function () {
  ...
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to('.projects-link', {
    color: '#163631',
    fontSize: '28px'
  });
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.fromTo('.projects', {
    x: '0%'
  }, {
    x: '-200%'
  });
...
contacts.addEventListener('click', function () {
  ...
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.fromTo('.contacts', {
    x: '-300%',
    y: '-300%'
  }, {
    y: 0,
