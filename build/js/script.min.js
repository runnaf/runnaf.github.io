...
var text = select('.preview__title');
var main = select('main');
var petItems = document.querySelectorAll('.projects__pet-link');
...
var links = document.querySelectorAll('.header-page__link');
